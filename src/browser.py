                    ...
                    "content": [
                        ...
                        },
                        {
                            ...
                            "text": (
                                ...
                                "We are trying to reach the Gifts tab to open chests.\n\n"
                                "Check if there's ANYTHING blocking the Gifts tab that needs to be dismissed:\n"
                                "- A 'proposal' or offer dialog (e.g., 'A proposal from...')\n"
                                "- A payment/purchase dialog with USD prices\n"
                                "- The Bonus Sales store (items for sale)\n"
                                "- Any store overlay ('Speed Up', 'Special Offer', etc.)\n"
                                "- Any centered dialog box overlaying the game\n\n"
                                "Only these are OK (don't dismiss):\n"
                                "- The Clan panel showing the Gifts tab with chest rows\n"
                                "- A list of chests showing player names and 'Open' buttons\n\n"
                                "If there IS something blocking, look for a VISIBLE X button.\n"
